  ...
  <div class="content">
    <div class="col-sm-6 col-sm-offset-2">
      ...
      <div class="box">
         <?php echo form_open('admins/amenities/edit');?>
          <div class="form-group">
            <input type="name" class="form-control" value="<?=$amenity['name']?>" name="name">
          </div>   
          <input type="hidden"  value="<?=base64_encode($amenity['id']);?>" name="id">     
